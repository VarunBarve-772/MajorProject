# Generated by Django 3.2.4 on 2021-10-06 17:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('age', models.IntegerField(validators=[auctions.models.age_validator])),
                ('gender', models.CharField(choices=[('M', 'male'), ('F', 'female'), ('O', 'not specified')], default='O', max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url', models.CharField(blank=True, default='https://cdn.pixabay.com/photo/2015/04/23/22/00/tree-736885_1280.jpg', max_length=2048, null=True)),
